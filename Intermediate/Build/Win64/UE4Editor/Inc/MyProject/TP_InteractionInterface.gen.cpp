...
#include "MyProject/TP_InteractionInterface.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	MYPROJECT_API UClass* Z_Construct_UClass_UTP_InteractionInterface_NoRegister();
	MYPROJECT_API UClass* Z_Construct_UClass_UTP_InteractionInterface();
	COREUOBJECT_API UClass* Z_Construct_UClass_UInterface();
	UPackage* Z_Construct_UPackage__Script_MyProject();
	ENGINE_API UClass* Z_Construct_UClass_USceneComponent_NoRegister();
// End Cross Module References
	DEFINE_FUNCTION(ITP_InteractionInterface::execDrop)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(ITP_InteractionInterface::execPickup)
	{
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UTP_InteractionInterface_Drop_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UTP_InteractionInterface, nullptr, "Drop", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UTP_InteractionInterface_Drop_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UTP_InteractionInterface_Drop_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UTP_InteractionInterface_Pickup_Statics::NewProp_AttachTo = { "AttachTo", nullptr, (EPropertyFlags)0x0010000000080080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(TP_InteractionInterface_eventPickup_Parms, AttachTo), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UTP_InteractionInterface_Pickup_Statics::NewProp_AttachTo_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UTP_InteractionInterface_Pickup_Statics::NewProp_AttachTo_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UTP_InteractionInterface_Pickup_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UTP_InteractionInterface, nullptr, "Pickup", nullptr, nullptr, sizeof(TP_InteractionInterface_eventPickup_Parms), Z_Construct_UFunction_UTP_InteractionInterface_Pickup_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UTP_InteractionInterface_Pickup_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UTP_InteractionInterface_Pickup_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UTP_InteractionInterface_Pickup_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTP_InteractionInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_InteractionInterface_Drop, "Drop" }, // 3785070479
		{ &Z_Construct_UFunction_UTP_InteractionInterface_Pickup, "Pickup" }, // 1394771180
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UTP_InteractionInterface_Statics::ClassParams = {
		...
		0,
		0x000840A1u,
		METADATA_PARAMS(Z_Construct_UClass_UTP_InteractionInterface_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UTP_InteractionInterface_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UTP_InteractionInterface, 2513490689);
	template<> MYPROJECT_API UClass* StaticClass<UTP_InteractionInterface>()
	{
		return UTP_InteractionInterface::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UTP_InteractionInterface(Z_Construct_UClass_UTP_InteractionInterface, &UTP_InteractionInterface::StaticClass, TEXT("/Script/MyProject"), TEXT("UTP_InteractionInterface"), false, nullptr, nullptr, nullptr);
